...
{
    public class CompiledBindingExpressionTests_AvaloniaProperty
    {
        public CompiledBindingExpressionTests_AvaloniaProperty()
        {
        ...
        {
            var data = new Class1();
            var target = CompiledBindingExpression.OneWay(data, o => o.ClrProperty);
            var result = await target.Take(1);
