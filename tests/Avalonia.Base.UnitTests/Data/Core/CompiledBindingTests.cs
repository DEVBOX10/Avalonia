...
namespace Avalonia.Markup.UnitTests.Data
{
    public class CompiledBindingTests
    {
        ...
        public void OneWay_Binding_Should_Be_Set_Up()
        {
            ...
            var binding = CompiledBinding<Source>.OneWay(o => o.Foo);
        ...
        public void TwoWay_Binding_Should_Be_Set_Up()
        {
            var source = new Source { Foo = "foo" };
            var target = new TextBlock { DataContext = source };
            var binding = CompiledBinding<Source>.TwoWay(o => o.Foo, (o, v) => o.Foo = v);
        ...
        public void TwoWay_Binding_Should_Be_Set_Up_GC_Collect()
        {
            ...
            var binding = CompiledBinding<WeakRefSource>.TwoWay(o => o.Foo, (o, v) => o.Foo = v);
        ...
        public void OneTime_Binding_Should_Be_Set_Up()
        {
            var source = new Source { Foo = "foo" };
            var target = new TextBlock { DataContext = source };
            var binding = CompiledBinding<Source>.OneTime(o => o.Foo);
        ...
        public void Default_BindingMode_Should_Be_Used()
        {
            ...
            var binding = CompiledBinding<Source>.Default(o => o.Foo, (o, v) => o.Foo = v);
        ...
        public void DataContext_Binding_Should_Use_Parent_DataContext()
        {
            ...
            var binding = CompiledBinding<IHeadered>.OneWay(x => x.Header);
        ...
        {
            var viewModel = new Source { Foo = "bar" };
        ...
        [Fact]
        public void Binding_With_Source_Should_Produce_Correct_Results()
        {
            var viewModel = new Source { Foo = "bar" };
        ...
        public void Should_Not_Write_To_Old_DataContext()
        {
            ...
            var fooBinding = CompiledBinding<OldDataContextViewModel>.TwoWay(o => o.Foo, (o, v) => o.Foo = v);
            var barBinding = CompiledBinding<OldDataContextViewModel>.TwoWay(o => o.Bar, (o, v) => o.Bar = v);
        ...
        [Fact]
        public void AvaloniaObject_this_Operator_Accepts_CompiledBinding()
        {
            ...
            target[!ContentControl.ContentProperty] = CompiledBinding<Source>.OneWay(o => o.Foo);
        ...
        private class OldDataContextTest : Control
        {
            ...
            {
                Bind(BarProperty, this.GetBindingObservable(FooProperty));
            }
        }
