...
{
    public class CompiledBindingExpressionTests_Indexer
    {
        [Fact]
        public async Task Should_Get_Array_Value()
        {
            var data = new { Foo = new[] { "foo", "bar" } };
            var target = CompiledBindingExpression.OneWay(data, x => x.Foo[1]);
        ...
        public async Task Should_Get_MultiDimensional_Array_Value()
        {
            ...
            var target = CompiledBindingExpression.OneWay(data, o => o.Foo[1, 1]);
            var result = await target.Take(1);
        ...
        public async Task Should_Get_Value_For_String_Indexer()
        {
            ...
            var target = CompiledBindingExpression.OneWay(data, o => o.Foo["foo"]);
            var result = await target.Take(1);
        ...
        public async Task Should_Get_Value_For_Non_String_Indexer()
        {
            ...
            var target = CompiledBindingExpression.OneWay(data, o => o.Foo[1.0]);
            var result = await target.Take(1);
        ...
        {
            var data = new { Foo = new[] { "foo", "bar" } };
            var target = CompiledBindingExpression.OneWay(data, o => o.Foo[2]);
            var result = await target.Take(1);
        ...
        {
            var data = new { Foo = new List<string> { "foo", "bar" } };
            var target = CompiledBindingExpression.OneWay(data, o => o.Foo[1]);
            var result = await target.Take(1);
        ...
        {
            var data = new { Foo = new AvaloniaList<string> { "foo", "bar" } };
            var target = CompiledBindingExpression.OneWay(data, o => o.Foo[0]);
        ...
        public async Task Indexer_Only_Binding_Works()
        {
            ...
            var target = CompiledBindingExpression.OneWay(data, o => o[1]);
