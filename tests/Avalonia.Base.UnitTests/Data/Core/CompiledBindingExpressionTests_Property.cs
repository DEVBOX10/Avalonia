...
{
    public class CompiledBindingExpressionTests_Property
    {
        [Fact]
        public async Task Should_Get_Root_Value()
        {
            var target = CompiledBindingExpression.OneWay("foo", o => o);
        ...
        public async Task Should_Get_Simple_Property_Value()
        {
            ...
            var target = CompiledBindingExpression.OneWay(data, o => o.Foo);
            var result = await target.Take(1);
        ...
        public void Should_Produce_Error_When_Root_Null()
        {
            ...
            var target = CompiledBindingExpression.OneWay(source, o => o.Foo);
        ...
        public async Task Should_Get_Simple_Property_Chain()
        {
            ...
            var target = CompiledBindingExpression.OneWay(data, o => o.Foo.Bar.Baz);
            var result = await target.Take(1);
        ...
        public void Should_Track_End_Of_Property_Chain_Changing()
        {
            ...
            var target = CompiledBindingExpression.OneWay(data, o => (o.Next as Class2).Bar);
            var result = new List<object>();
        ...
        public void Should_Track_Property_Chain_Breaking_With_Null_Then_Mending()
        {
            ...
            var target = CompiledBindingExpression.OneWay(data, o => ((o.Next as Class2).Next as Class2).Bar);
            var result = new List<BindingValue<string>>();
        ...
        {
            Func<Tuple<CompiledBindingExpression<Class1, string>, WeakReference>> run = () =>
            {
